...
\titleformat{name=\subsection}[block]
    ...
    {1em}
    {\colorsubsection}
% 1 and #1 indicates where the content is placed
\newcommand{\colorsubsection}[1]{%
  \colorbox{subsection}{\parbox{\dimexpr\textwidth-13\fboxsep}{#1}}}
...
\newcommand{\colorsection}[1]{%
  \colorbox{subsubsection}{\parbox{\dimexpr\textwidth-14\fboxsep}{#1}}}
% ---------------------------------------------------
...
\input{sections/protocol_intro}
\newpage
\input{sections/protocol_reproduction}
\input{sections/protocol_guidelines}
\input{sections/protocol_end}
