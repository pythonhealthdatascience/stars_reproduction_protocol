...
\hl{diference in "complete" between table 1 and 2 - is table 1 more light touch? how do we distinguish when evaluating. do we go more light touch? is it possible for us to given how deep we go with this?}
